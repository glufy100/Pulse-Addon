package Glufy.Pulse.modules.Player;
...
public class GhostMode extends Module {
    ...
    public GhostMode() {
        super(Categories.Player, "ghost-mode", "Allows you to keep playing after you die. Works on Forge, Fabric and Vanilla servers.");
    }
