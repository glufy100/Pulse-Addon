...
import Glufy.Pulse.modules.Movement.FlightAntikick;
import Glufy.Pulse.modules.Movement.TPFly;
...
public class AutoMountain extends Module {
    ...
    public AutoMountain() {
        super(PulseAddon.Build, "AutoMountain", "Make Mountains!");
    }
    ...
    public void onActivate() {
        ...
        if (startPaused.get() || isInvalidBlock(mc.player.getInventory().getMainHandStack().getItem().getDefaultStack())) return;
