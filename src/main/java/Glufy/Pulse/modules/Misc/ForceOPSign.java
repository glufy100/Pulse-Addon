...
public class ForceOPSign extends Module {
    ...
    public ForceOPSign() {
        super(Categories.Misc, "ForceOPSign", "Requires Creative mode! Creates a ClickEvent sign in your inventory. Give it to someone with OP who is also in creative mode and have them place then click the sign.");
    }
