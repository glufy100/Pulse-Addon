...
public class OPplayerTPmodule extends Module {
    ...
    public OPplayerTPmodule() {
        super(PulseAddon.Automation, "OPplayerTPmodule", "**REQUIRES OP** Teleports you to each player on the server with a button press if keybound, or teleport people to you.");
    }
