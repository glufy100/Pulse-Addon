...
import static Glufy.Pulse.utils.HIGUtils.getHighway;
...
public class AutoCenter extends Module {
    ...
    public AutoCenter() {
        super(PulseAddon.Automation, "auto-center", "Automatically centers the player so that HighwayBorers mine on axis.");
    }
